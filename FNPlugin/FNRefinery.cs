...
namespace FNPlugin 
{
    ...
    class FNRefinery : FNResourceSuppliableModule 
    {
        ...
        public override void OnStart(PartModule.StartState state) 
        {
            ...
            if (part.airlock != null && part.airlock.transform != null && part.airlock.transform.gameObject != null) 
        ...
        public override void OnUpdate() 
        {
            ...
            if (IsEnabled) 
            {
                ...
                { 
                    ...
                    double anthraratetmp = anthra_rate_d * GameConstants.HOUR_SECONDS;
                ...
                { 
                    ...
                    double monoratetmp = monoprop_rate_d * GameConstants.HOUR_SECONDS;
                ...
                { 
                    ...
                    double uraniumnitrideratetmp = uranium_nitride_rate_d * GameConstants.HOUR_SECONDS;
                ...
                { 
                    ...
                    double ammoniaratetmp = ammonia_rate_d * GameConstants.HOUR_SECONDS;
